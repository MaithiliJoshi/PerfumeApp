...
abstract class PerfumeDatabase : RoomDatabase(){
    ...
    companion object {
                        ...
                        .fallbackToDestructiveMigration().addCallback(object : RoomDatabase.Callback() {
                            override fun onCreate(db: SupportSQLiteDatabase) {
                                ...
                                Executors.newSingleThreadExecutor().execute(){
                                    getInstance(context).perfumeDao
        ...
        val PREPOPULATE_DATA = listOf<Perfume>(
            Perfume(1,"","Coolwater","Aqua","Davidoff",4600),
            Perfume(2,"","Yellow Diamond","Fruity Floral","Versace",5000)
        )
